        ...
        <>
            {activeTab == 'home' && <div id="sticky-banner" tabIndex="-1" className="fixed top-0 left-0 z-50 justify-between w-full p-4 border-b border-gray-200 bg-gray-50">
                <div className="flex items-center justify-between mx-auto">
                    ...
                    <div onClick={() => exitMiniApp()}>
                        <svg fill="#6b6b6b" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            width="25px" height="25px" viewBox="0 0 471.851 471.851"
                            xmlSpace="preserve">
                        <g>
                            <g>
            ...
            <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200">
                <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                    ...
                    <svg
                        ...
                        fill={activeTab === 'home' ? '#5185FE' : 'currentColor'} // Control fill color here
  >
                    <g clipPath="url(#clip0_27_586)">
                    <path d="M23.996 9.06899L16.411 1.48299C15.4723 0.546978 14.2007 0.0213623 12.875 0.0213623C11.5494 0.0213623 10.2778 0.546978 9.33901 1.48299L1.75401 9.06899C1.47444 9.34677 1.25278 9.67729 1.10189 10.0414C0.951007 10.4055 0.87389 10.7959 0.875012 11.19V21.007C0.875012 21.8026 1.19108 22.5657 1.75369 23.1283C2.3163 23.6909 3.07936 24.007 3.87501 24.007H21.875C22.6707 24.007 23.4337 23.6909 23.9963 23.1283C24.5589 22.5657 24.875 21.8026 24.875 21.007V11.19C24.8761 10.7959 24.799 10.4055 24.6481 10.0414C24.4972 9.67729 24.2756 9.34677 23.996 9.06899ZM15.875 22.007H9.87501V18.073C9.87501 17.2773 10.1911 16.5143 10.7537 15.9517C11.3163 15.3891 12.0794 15.073 12.875 15.073C13.6707 15.073 14.4337 15.3891 14.9963 15.9517C15.5589 16.5143 15.875 17.2773 15.875 18.073V22.007ZM22.875 21.007C22.875 21.2722 22.7697 21.5266 22.5821 21.7141C22.3946 21.9016 22.1402 22.007 21.875 22.007H17.875V18.073C17.875 16.7469 17.3482 15.4751 16.4105 14.5375C15.4729 13.5998 14.2011 13.073 12.875 13.073C11.5489 13.073 10.2772 13.5998 9.33948 14.5375C8.4018 15.4751 7.87501 16.7469 7.87501 18.073V22.007H3.87501C3.6098 22.007 3.35544 21.9016 3.16791 21.7141C2.98037 21.5266 2.87501 21.2722 2.87501 21.007V11.19C2.87594 10.925 2.9812 10.671 3.16801 10.483L10.753 2.89999C11.3167 2.33892 12.0797 2.02393 12.875 2.02393C13.6703 2.02393 14.4333 2.33892 14.997 2.89999L22.582 10.486C22.7681 10.6732 22.8733 10.926 22.875 11.19V21.007Z"/>
                    </g>
                    <defs>
                    ...
                    <svg width="25" height="24" viewBox="0 0 25 24" fill={activeTab === 'profile' ? '#5185FE' : 'currentColor'} xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path fillRule="evenodd" clipRule="evenodd" d="M12.125 4C10.4681 4 9.125 5.34315 9.125 7C9.125 8.65685 10.4681 10 12.125 10C13.7819 10 15.125 8.65685 15.125 7C15.125 5.34315 13.7819 4 12.125 4ZM7.125 7C7.125 4.23858 9.36358 2 12.125 2C14.8864 2 17.125 4.23858 17.125 7C17.125 9.76142 14.8864 12 12.125 12C9.36358 12 7.125 9.76142 7.125 7Z"/>
                        </svg>
