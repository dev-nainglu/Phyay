    ...
    return (
        <>
            ...
            {cards.map((card, index) => (
                ...
                <li class="py-3 sm:py-4" last={index === cards.length-1}>
                    ...
                    <div className="rounded-full w-10 h-10" style={{ whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', padding: 10, backgroundColor: '#EBF1FF', borderRadius: 10}}>
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium dark:text-900 truncate">
                               {card.settingName}
                            </p>
                        </div>
                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                        <button type="button" class="text-white font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2">
                    ...
                    <hr class="mt-5 my-0.5 border-t border-gray-300" style={index === cards.length - 1 ? { display: 'none' } : {}} />
                </li>
                </ul>
            ))}
            </div>
