  ...
  return (
    <>
            ...
            {cards.map((card, index) => (
                ...
                <img className="object-cover w-full rounded-t-lg h-20 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" 
                ...
                <div className="flex-col justify-between p-4 leading-normal">
                    ...
                    <a
                href="#"
                className="inline-flex items-center px-3 py-2 text-sm font-medium text-white rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                style={{ width: '113.5px', height: '35px', backgroundColor: '#5185FE', textAlign: 'center' }}
                >
                Consult Now
                </a>
                </div>
