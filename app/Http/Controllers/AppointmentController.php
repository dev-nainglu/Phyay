...
class AppointmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $patient = Patient::where('phone_number', $request->phone)->first();
        if (!$patient) {
        ...
        if($appointment){
            ...
            $startTime = Carbon::createFromFormat('Y-m-d H:i:s', $appointment->appointment_start_date, 'Asia/Rangoon')->setTimezone('UTC')->format('Y-m-d\TH:i:s\Z');
            ...
            $appointment->meeting_link = $meetings['data']['join_url'];
            $appointment->save();
            // return $appointment;
